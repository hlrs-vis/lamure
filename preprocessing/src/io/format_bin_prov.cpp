...
void format_bin_prov::read(const std::string& filename, surfel_callback_function callback)
{
...
void format_bin_prov::write(const std::string& filename, buffer_callback_function callback)
{

  throw std::runtime_error("output for format .bin_prov not implemented");
}
