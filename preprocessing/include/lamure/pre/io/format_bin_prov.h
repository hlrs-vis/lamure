...
#ifndef PRE_FORMAT_BIN_PROV_H_
#define PRE_FORMAT_BIN_PROV_H_
...
class PREPROCESSING_DLL format_bin_prov : public format_abstract
{
public:
    explicit format_bin_prov()
                            : format_abstract()
                            { has_normals_ = true;
                              has_radii_   = true;
                              has_color_   = true; }
